...
// Lote NOTA-2: a montagem da mensagem saiu daqui para `format.js`. Este arquivo
// sobe o servidor ao ser importado, e por isso a função não tinha como ser
// testada sem abrir uma porta.
const { formatRollMessage } = require('./format');
