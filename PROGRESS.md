...
4. [ ] Estender padrão único de card para Equipamentos, Defesas e Rolagem.
5. [ ] Unificar diálogos de seleção/edição (título, densidade, ações finais).
6. [ ] Rodar checklist de contraste/foco/rótulos TalkBack.
7. [ ] Validar em emulador visual e pracego.
