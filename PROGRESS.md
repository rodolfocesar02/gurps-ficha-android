...
* [Feito] Lote 114: Blindagem de Conectividade & Contexto Arcano | `(Commit: 9cb6448)`
    ...
    - **Fidelidade BibliogrÃ¡fica:** CorreÃ§Ã£o de dados no `magias2versao.json` (Sopro de Fogo/Ã�cido/Frio) alinhando "ResistÃªncia" com o MÃ³dulo BÃ¡sico.
...
Impacto em Alta Velocidade: "Um cavaleiro em carga a cavalo (Move 8) atinge um soldado com uma lanÃ§a. Como calculo o dano de colisÃ£o baseado na ST do cavalo?"
Regras de Afogamento: "Meu personagem caiu em um rio e estÃ¡ sem fÃ´lego. Quanto tempo ele aguenta antes de comeÃ§ar a perder PV e quais sÃ£o os testes de HT?"
Visibilidade CrÃ­tica: "Estou tentando atirar em um alvo na escuridÃ£o total, mas tenho 'VisÃ£o Noturna 5'. Qual a minha penalidade final?"
Equipamentos e Carga: "Estou carregando 40kg de ouro. Minha ST Ã© 10. Como isso afeta minha Esquiva e meu Deslocamento atual?"
...
CriaÃ§Ã£o de Especialista: "Gere uma ficha de um Ninja especializado em infiltraÃ§Ã£o tecnolÃ³gica (NT 9), com 'MÃ£os Pegajosas' e 'Passo Leve', usando 150 pontos."
...
CriaÃ§Ã£o de Especialista: "Gere uma ficha de um Ninja especializado em infiltraÃ§Ã£o tecnolÃ³gica (NT 9), com 'MÃ£os Pegajosas' e 'Passo Leve', usando 150 pontos."
Regra de Recuo (Armas de Fogo): "Se eu der uma rajada de 3 tiros com uma submetralhadora de Recuo 2, como calculo quantos tiros acertaram?"
Sufocamento por FumaÃ§a: "O prÃ©dio estÃ¡ pegando fogo! Quais sÃ£o os testes para nÃ£o desmaiar por inalaÃ§Ã£o de fumaÃ§a a cada turno?"
Salto em DistÃ¢ncia: "Tenho ST 12 e DX 11 e HT 10. Qual a distÃ¢ncia mÃ¡xima que consigo saltar com uma corrida prÃ©via?"
Magia e Fadiga: "Se eu conjurar 'Bola de Fogo' gastando 3 pontos de fadiga, mas minha AptidÃ£o MÃ¡gica for 2, quanto tempo levo para carregar a magia?"

"Segundo CÃ©rebro" (O Validador de Regras).(vamos pensar niisso!)
### Lote 114: Consolidação de Arquitetura e Auditoria Subaquática
