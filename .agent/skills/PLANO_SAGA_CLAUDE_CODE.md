...
> - ➡️ Em andamento: melhorias de combate pedidas (narração + manobras com opções) e **validação no aparelho**. Regras já lidas no Códex p/ as manobras: Apontar (+Prec), Avaliar (+1..+3), Preparar (sacar arma), Mudança de Posição.
